...
const OurJourney = forwardRef((props, ref) => {
  return (
    ...
    >
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl mx-auto mt-8 text-xs text-justify max-h-[550px] overflow-y-auto w-full">
        <p className="mb-4">
          ...
          sedikit usaha untuk menyerahkan buku ke arah meja salah satu siswa
          yang sejajar dengannya. Hanya berjarak dua meja di kelas itu.
        </p>
        <p className="mb-4">
          ...
          Menutup buku itu. Dan kemudian menyerahkan ke teman di sebelahnya
          dengan ucapaan “Kasih ke Thariq.
        </p>
        ...
        <p className="mb-4">
          ...
          kegalauan. Kemudian Lusi, Sahabat Sherly, meminta Thariq untuk menemui
          Sherly di Rumah Lusi.
        </p>
        <p className="mb-4">
          Sahabat Sherly, membanjiri laki-laki itu dengan pertanyaan yang belum
          pernah ia dapatkan. Dan juga Lusi memberikan support agar Sherly
          kembali meraih mimpinya di UNPAD.
        </p>
        <p className="mb-4">
          Sherly dilanda dilema berikutnya setelah dinyatakan lolos di FIKOM
          UNPAD. Ada pilihan UNPAD, atau STMIK Indonesia Padang dengan beasiswa.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          teman-teman menuliskan nama yang dianggap melanggar aturan asrama.
          Ayah menemukan satu pengaduan untuk nama Sherly dan Thariq”
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          Mereka kembali menjadi teman belajar. Tahun 2023, Thariq meminta
          upgrade pertemanan. Dari sekedar teman belajar menjadi teman belajar
          seumur hidup.
        </p>
        <p className="mb-4">
